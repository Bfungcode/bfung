...
const Projects = ({ isLarge, handleMouseEnter, handleMouseLeave }) => {
  ...
  return (
    <>
      {isLarge ? (
        <div className="w-full  flex flex-col border-t-2 border-black overflow-hidden">
          ...
          <div className="w-full h-full flex flex-col flex-wrap flex-1 relative">
                ...
                <div className="w-[80%] h-full flex-col flex-wrap p-2">
                  ...
                  <div className="w-full h-[95%] flex flex-col flex-wrap gap-2">
                    <div className="w-full h-[30%] flex flex-row flex-wrap font-bold gap-2">
                      <div className="text-[14px] text-black w-[65%]">
                        {projectsData[0].words1}
                      </div>
                      <div className="text-[14px] text-black w-[34%] font-bold">
              ...
              <div className="w-full h-[200px] flex flex-row justify-between flex-wrap  ">
                {hover1 ? (
                  ...
                  <>
                    ...
                    <div
                      className="w-[70%] h-full border-black border-b-2 border-l-2 flex flex-row flex-wrap  p-2 cursor-pointer transition-all duration-1000 ease-in-out "
                      onMouseMove={handleMouseEnter(setHover1)}
                      onMouseLeave={handleMouseLeave(setHover1)}
                      onClick={() => turnPt(setTurn1, turn1)}
                    >
            ...
            {turn2 ? (
                  ...
                  <div className="w-full h-[95%] ">
                    ...
                    <div className="w-full h-[70%] flex flex-row flex-wrap p-2 transition-all duration-1000 ease-in-out justify-center items-center">
                      ...
                      <div className="w-[35%] h-[80%] p-2 flex flex-col flex-wrap">
                        <div className="w-full h-[45%] flex flex-col flex-wrap justify-center items-center">
                          <div className="text-lg text-black font-bold h-[10%]">
                            Login Page
                          </div>
                          <img
                            src="/ch3.png"
              ...
              <div className="w-full h-[200px] flex flex-row justify-between flex-wrap z-0">
                {hover2 ? (
                  <>
                    <div
            ...
            {turn3 ? (
              <div className="w-full h-full flex flex-row justify-between flex-wrap  transition-all duration-1000 ease-in-out border-black border-b-2 z-10 ">
                ...
                <div className="w-[80%] h-full flex flex-col flex-wrap p-2 ">
                  <div className="w-full h-[5%] text-xl font-primary font-bold text-black pt-2 ">
                    Project Description
                  </div>
              ...
              <div className="w-full h-[200px] flex flex-row justify-between flex-wrap ">
                {hover3 ? (
                  <>
                    <div
                      className="w-full h-full border-black border-b-2 flex flex-row flex-wrap cursor-pointer  p-2 transition-all duration-1000 ease-in-out"
                  ...
                  <>
                    ...
                    <div
                      className="w-[70%] h-full border-black border-b-2  border-l-2 flex flex-row flex-wrap  p-2 cursor-pointer"
                      onMouseMove={handleMouseEnter(setHover3)}
                      onMouseLeave={handleMouseLeave(setHover3)}
                      onClick={() => turnPt(setTurn3, turn3)}
                    >
            ...
            {turn4 ? (
              ...
              <div className="w-full h-[200px] flex flex-row justify-between flex-wrap  transition-all duration-1000 ease-in-out">
                {hover4 ? (
                  <>
                    <div
                        ...
                        <div className="w-full h-full p-4 flex flex-col flex-wrap">
                          <div className="w-full h-[65%] md:h-[55%]">
                            ...
                            <div className="w-full h-[60px]">
                              ...
                              <div className="font-primary text-black md:text-[20px]">
                                {project.year}
                              </div>
                            </div>
                            <div className="w-full h-[60px]">
                              ...
                              <div className="font-primary text-black"></div>
                            </div>
                            <div className="w-full h-[60px]">
                              <div className="font-primary font-semibold md:text-[22px]">
                                Publication Link
                  ...
                  {project.state ? (
                    <>
                      <div className="h-[600px] md:h-[800px] w-full border-b-2 border-black flex flex-col flex-wrap  relative transition-all duration-1000 ease-out">
                        ...
                        <div className="w-full h-full p-4 flex flex-col flex-wrap text-black">
                          <div className="w-full h-[65%] md:h-[55%]">
                            <div className="w-full h-[60px] font-secondary text-[28px] md:text-[42px] flex justify-center items-center font-bold">
                              {project.name}
                            </div>
                            ...
                            <div className="w-full h-[60px]">
                              ...
                              {Array.isArray(project.link) ? (
                                <>
                                  <div className="font-primary text-black flex gap-1 md:text-[20px]">
...

{
  /* {isLarge ? (
        <div className="w-full h-full flex flex-col flex-wrap  border-2 border-black border-b-0 ">
          <div className="w-full h-[800px]  text-black font-secondary text-[62px]  flex flex-row border-b-2 border-black flex-wrap">
          ...
          <div className="w-full h-full flex flex-col flex-wrap flex-1 relative">
            ...
            {turn2 ? (
              <div className="w-full h-full flex flex-row justify-between flex-wrap  transition-all duration-1000 ease-in-out border-black border-l-2 border-r-2 border-b-2  text-black z-0">
                <div className="w-[20%] h-full flex flex-col flex-wrap p-2 break-words">
                  <div className="w-full h-[60%] flex flex-col flex-wrap">
                    <div className="h-[15%] w-full text-4xl font-primary font-bold pb-8">
                      CryptoHex
            ...
            {turn4 ? (
              <div className="w-full h-full flex flex-row justify-between flex-wrap  transition-all duration-1000 ease-in-out border-black border-l-2 border-r-2 border-b-2  text-black">
                <div className="w-[20%] h-full flex  flex-wrap p-2 break-words">
                  <div className="w-full h-[60%] flex  flex-wrap">
                    <div className="h-[15%] w-full text-4xl font-primary font-bold pb-8">
                      Easy Features
              ...
              <div className="w-full h-[200px] flex flex-row justify-between flex-wrap  transition-all duration-1000 ease-in-out">
                {hover4 ? (
                  ...
                  <>
                    ...
                    <div
                      className="w-[70%] h-full border-black border-b-2 border-r-2 border-l-2 flex flex-row flex-wrap  p-2 cursor-pointer "
                      onMouseMove={handleMouseEnter(setHover4)}
                      onMouseLeave={handleMouseLeave(setHover4)}
                      onClick={() => turnPt(setTurn4, turn4)}
                    >
        ...
        <div className="w-full h-full flex flex-col flex-wrap  border-2 border-black border-b-0 ">
          <div className="w-full h-[80px]  text-black font-secondary text-[52px] md:text-[72px] text-center flex justify-center items-center border-b-2 border-black">
            <div> Projects</div>
          </div>
          {projectsData.map((project) => (
            <>
